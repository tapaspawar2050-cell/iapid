...
const Footer = () => {
  return (
    <footer className="w-full">
      ...
      >
        <div className="max-w-[2000px] mx-auto px-6 md:px-20 py-6">
          ...
          <div className="w-full md:w-[60%]">
            ...
            <div className="flex flex-col md:flex-row items-start gap-8 mt-12">
              ...
              <div className="flex gap-5">
                ...
                <div className="bg-black text-white p-3 rounded-full hover:scale-110 transition cursor-pointer">
                  <FaTwitter />
                </div>
                <div className="bg-red-500 text-white p-3 rounded-full hover:scale-110 transition cursor-pointer">
                  <FaGoogle />
                </div>
              </div>
